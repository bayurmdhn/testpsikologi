...
export default function Question() {
  ...
  useEffect(() =>{
    axios.get("https://dev-quizbde6t.microgen.id/api/questions?select=questionChoices,question&limit=20&where[categories]=SOAL_I")
    .then(res => res.data)
  ...
  return (
        <div>
          ...
          <h1 className="text-center font-bold text-xl">Soal ke-9</h1>
