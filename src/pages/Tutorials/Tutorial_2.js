...
export default function Tutorial() {
  ...
  useEffect(() =>{
    axios.get("https://dev-quizbde6t.microgen.id/api/tutorials?,tutorial&limit=20&where[categories]=TUTORIAL_B")
    .then(res => res.data)
  ...
  return (
        <div>
          ...
          <h1 className="text-center font-bold text-xl">Cara Mengerjakan Soal ke-2</h1>
